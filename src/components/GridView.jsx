...
const GridView = ({ className }) => {
  ...
  useEffect(() => {
    // Alert data that matches the alerts from AlertsView
    const alertsData = {
      "TC001": {
        type: "critical",
        title: "Unit Offline",
    ...
    if (userRole === "admin") {
      ...
      setUnits(mappedUnits.slice(0, 6));
    }
  }, [userRole]);
